...
export component QuickLinks(children: any) {
  render (
...
export component QuickLink(title: string, description: string, href: string, icon: string) {
  render (
    <div class="group relative rounded-xl border border-slate-200 dark:border-slate-800">
      ...
      <div class="relative overflow-hidden rounded-xl p-6">
        <div innerHTML={icon} class="h-8 w-8 [&>svg]:h-8 [&>svg]:w-8" />
        <h2 class="mt-4 font-display text-base text-slate-900 dark:text-white">
          <Link to={href as any} class="no-underline">
