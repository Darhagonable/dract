import { DarkMode, Gradient, LightMode, type ColorName } from '../Icon'

export component PluginsIcon(id: string, color: ColorName) {
  render (
		<defs>
			<Gradient
				id={`${id}-gradient`}
		...
		<DarkMode stroke-width={2} stroke-linecap="round" stroke-linejoin="round">
			<path
